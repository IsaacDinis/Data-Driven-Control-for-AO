...
if __name__ == "__main__":
    ...
    for i in range(n_iter):
        supervisor.target.set_tar_phase(0,phase_tilt[i]*tilt)
    ...
    pfits.writeto("../data3/res_DM0_alone.fits", res_DM0, overwrite = True)
    pfits.writeto("../data3/res_DM0_proj.fits", res_DM1, overwrite = True)
