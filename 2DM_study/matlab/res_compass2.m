res_DM0_alone = fitsread('../data2/res_DM0_alone.fits');
res_DM1_alone = fitsread('../data2/res_DM1_alone.fits');
res_DM0 = fitsread('../data2/res_DM0.fits');
res_DM1 = fitsread('../data2/res_DM1.fits');
res_DM0_proj = fitsread('../data2/res_DM0_proj.fits');
res_DM0_alone_1kHz = fitsread('../data2/res_DM0_alone_1kHz.fits');
dist = fitsread('../data2/dist_DM1.fits');
dist_DM0 = fitsread('../data2/dist_DM0.fits');
dist_DM0_1kHz = fitsread('../data2/dist_DM0_1kHz.fits');
% res_DM1_alone_proj_1kHz = fitsread('../data/res_DM1_alone_projeted_1kHz.fits');
res_DM1_proj = fitsread('../data2/res_DM1_proj.fits');
