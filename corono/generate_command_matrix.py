...
if __name__ == "__main__":
    ...
    for mode in range(nmodes-2,nmodes):
        supervisor.rtc.set_perturbation_voltage(0, "", inf_mat[:,mode]*0.01) 
        supervisor.next()
        supervisor.next()
        slopes = supervisor.rtc.get_slopes(0)/0.01
        imat[:,mode] = slopes.copy()
    # #tip
