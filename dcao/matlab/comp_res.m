...
tilt_saxoplus_dcao = fitsread('../data/tilt_saxoplus_dcao2.fits')*1000;
command_rms_dcao = fitsread('../data/res_rms_dcao2.fits')*1000;
command_rms_standalone = fitsread('../data/res_rms2_standalone.fits')*1000;
T = 1;
...
% %%
figure()
plot(command_rms_dcao)
hold on;
plot(command_rms_standalone)
...
[psd_saxoplus_standalone,f] = compute_psd((command_rms_standalone)',n,w,fs);
[psd_saxoplus_dcao,f] = compute_psd((command_rms_dcao)',n,w,fs);
