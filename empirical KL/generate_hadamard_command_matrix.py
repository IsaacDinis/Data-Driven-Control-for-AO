...
if __name__ == "__main__":
    ...
    hadamard_matrix_2 = hadamard_matrix.copy()
    hadamard_matrix_2 = np.reshape(hadamard_matrix_2[:n_act,:n_act],n_act*n_act)
    # # ampli = 0.01
    ...
    supervisor.rtc.set_perturbation_voltage(0, "", hadamard_matrix_2*ampli)
    supervisor.next()
    supervisor.next()
    ...
    # np.savetxt('../../control_matrices/command_mat_KL2V.csv', command_mat, delimiter=",")
