contrast_int = fitsread('../results/standalone/integrator_05/contrastCurves/saxoplus.fits');
...
strehl_int = fitsread('../results/standalone/integrator_05/strehlCurves/saxoplus.fits');
