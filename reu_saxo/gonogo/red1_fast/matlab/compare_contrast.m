contrast_int_st = fitsread('../results/standalone/integrator_03/contrastCurves/saxoplus.fits');
...
strehl_int_st = fitsread('../results/standalone/integrator_03/strehlCurves/saxoplus.fits');
...
xlabel('r (lamb/D)')
ylabel('contrast')
title('Red 1 fast, saxo+ contrast after perfect coronograph')
subtitle("G mag = 11.9, J mag = 8.5, t0 = 2 ms, seeing = 0.7""")
grid()
