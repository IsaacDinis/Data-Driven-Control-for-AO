...
contrast_int_dcao = fitsread('../results/dcao/integrator_03/contrastCurves/saxoplus.fits');
...
strehl_int_dcao = fitsread('../results/dcao/integrator_03/strehlCurves/saxoplus.fits');
