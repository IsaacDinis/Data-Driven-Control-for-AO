contrast_int_st = fitsread('../results/standalone/integrator/contrastCurves/saxoplus.fits');
...
strehl_int_st = fitsread('../results/standalone/integrator/strehlCurves/saxoplus.fits');
...
legend_dd_st = sprintf('standalone order 3 datadriven, strehl = %.2f',strehl_dd_st);
...
legend_dd_dcao = sprintf('dcao order 3 datadriven, strehl = %.2f',strehl_dd_dcao);
