...
psd_path = '../results/bright1_03_2ms/cao/saxoplus_KL_psd.fits';
psd_03_02ms_cao = fitsread(psd_path);

psd_path = '../results/bright1_09_2ms/cao/saxoplus_KL_psd.fits';
psd_09_02ms_cao = fitsread(psd_path);

psd_path = '../results/bright1_09_8ms/cao/saxoplus_KL_psd.fits';
...
psd_path = '../results/bright1_03_2ms/dcao/saxoplus_KL_psd.fits';
psd_03_02ms_dcao = fitsread(psd_path);

psd_path = '../results/bright1_09_2ms/dcao/saxoplus_KL_psd.fits';
psd_09_02ms_dcao = fitsread(psd_path);

psd_path = '../results/bright1_09_8ms/dcao/saxoplus_KL_psd.fits';
...
title('saxo+ DCAO 1st KL residual PSD bright 1')
legend('0.3" 0.2ms','0.9" 0.2ms','0.9" 0.8ms','0.3" 0.8ms')
% legend_stand_g3 = sprintf('standalone: gain = 0.3 rms = %.2f',rms_standalone_g3);
% legend_dcao_g3 = sprintf('dcao: gain = 0.3 rms = %.2f',rms_dcao_g3);
% legend(legend_stand_g3,legend_dcao_g3)
...
%%
res_path = '../results/bright1_03_2ms/cao/saxoplus_KL_res.fits';
...
res_path = '../results/bright1_09_2ms/cao/saxoplus_KL_res.fits';
rms_09_02ms_cao = rms(fitsread(res_path));

res_path = '../results/bright1_09_8ms/cao/saxoplus_KL_res.fits';
rms_09_08ms_cao = rms(fitsread(res_path));


res_path = '../results/bright1_03_2ms/dcao/saxoplus_KL_res.fits';
...
res_path = '../results/bright1_09_2ms/dcao/saxoplus_KL_res.fits';
rms_09_02ms_dcao = rms(fitsread(res_path));

res_path = '../results/bright1_09_8ms/dcao/saxoplus_KL_res.fits';
...
title('saxo+ standalone KL residual RMS bright 1 per mode')
legend('0.3" 0.2ms','0.9" 0.2ms','0.9" 0.8ms','0.3" 0.8ms')
xlabel('mode')
ylabel('RMS')
...
title('saxo+ DCAO KL residual RMS bright 1 per mode')
legend('0.3" 0.2ms','0.9" 0.2ms','0.9" 0.8ms','0.3" 0.8ms')
xlabel('mode')
ylabel('RMS')