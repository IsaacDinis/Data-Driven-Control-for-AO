...
path = '../results/bright1_03_8ms/dcao_2/'
modal_res = pfits.getdata(path +'saxoplus_KL_phase_res.fits')
mode = 0
fs = 2760
n_average = 60
window_size = 200
...
pfits.writeto(path+'saxoplus_KL_phase_psd.fits', psd, overwrite = True)
