...
seeing        = [0.4]  # [arcsec]
coherenceTime = [9]  # [ms]
photFluxStage1 = [10600000] # [photons / m2 / s]
photFluxStage2 = [10900000]  # [photons / m2 / s]
...
config1=ParamConfig("../cases/saxoBright1Exc.py")
config2=ParamConfig("../cases/saxo+Bright1Exc.py")
