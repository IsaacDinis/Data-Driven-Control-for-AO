...
xlabel('Time (s)')
ylabel('Res. amp. (nm)')
legend('Both DMs','HODM only','Interpreter','latex');
make_it_nicer()
subplot(1,2,2)
...
xlabel('Time (s)')
ylabel('Res. amp. (nm)')
legend('Both DMs','LODM only','Interpreter','latex');
make_it_nicer()
subplot(1,2,2)
plot(t(start:end),res_DM1_proj(start:end))
xlabel('Time (s)')
ylabel('Res. amp. (nm)')
legend('HODM only','Interpreter','latex','location','southeast');
sgtitle('Residual on LODM 1st KL','Interpreter','latex','Fontsize',20)
set(gcf, 'Position',  [100, 100, 1400, 450])
set(gcf,'PaperType','A4')
make_it_nicer()
...
legend('LODM only','HODM only','both DMs','Interpreter','latex', 'Location','southeast');
make_it_nicer()
set(gcf, 'Position',  [100, 100, 700, 450])
set(gcf,'PaperType','A4')
make_it_nicer()
